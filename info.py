...
auth_channel = environ.get('AUTH_CHANNEL','-1001855595271')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001956386273')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001693717000')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MOVIES_REQUEST_NOW_2_0')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/bot_Update_jishu')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/bot_Update_jishu')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', '🤣 ᴊɪꜱʜᴜ ʙᴀʙᴀ 🤣')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MOVIES_REQUEST_NOW_2_0')
